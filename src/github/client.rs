...
// SPKI SHA-256 pins for GitHub's certificate hierarchies. Pinning is an
// *additional* constraint applied after standard WebPKI chain validation
// (see `PinnedCertVerifier`), so it narrows which intermediates we accept
// without weakening name/expiry/revocation checks.
//
// Two hierarchies must be covered because `hasp self-check` follows GitHub's
// 302 redirect from github.com to the release-asset CDN:
//   * api.github.com / github.com  → Sectigo (first three pins)
//   * release-assets.githubusercontent.com / objects.githubusercontent.com
//       → Let's Encrypt (the R* / E* intermediates below)
// All current Let's Encrypt intermediates are pinned so routine intermediate
// rotation (R10–R13, E5–E8) does not break the integrity check.
pub(super) const PINNED_SPKI_HASHES: &[[u8; 32]] = &[
    ...
    // R10 (Let's Encrypt RSA) intermediate
    [
        0x2b, 0xba, 0xd9, 0x3a, 0xb5, 0xc7, 0x92, 0x79, 0xec, 0x12, 0x15, 0x07, 0xf2, 0x72, 0xcb,
        0xe0, 0xc6, 0x64, 0x7a, 0x3a, 0xae, 0x52, 0xe2, 0x2f, 0x38, 0x8a, 0xfa, 0xb4, 0x26, 0xb4,
        0xad, 0xba,
    ],
    // R11 (Let's Encrypt RSA) intermediate
    [
        0x6d, 0xda, 0xc1, 0x86, 0x98, 0xf7, 0xf1, 0xf7, 0xe1, 0xc6, 0x9b, 0x9b, 0xce, 0x42, 0x0d,
        0x97, 0x4a, 0xc6, 0xf9, 0x4c, 0xa8, 0xb2, 0xc7, 0x61, 0x70, 0x16, 0x23, 0xf9, 0x9c, 0x76,
        0x7d, 0xc7,
    ],
    // R12 (Let's Encrypt RSA) intermediate
    [
        0x91, 0x9c, 0x0d, 0xf7, 0xa7, 0x87, 0xb5, 0x97, 0xed, 0x05, 0x6a, 0xce, 0x65, 0x4b, 0x1d,
        0xe9, 0xc0, 0x38, 0x7a, 0xcf, 0x34, 0x9f, 0x73, 0x73, 0x4a, 0x4f, 0xd7, 0xb5, 0x8c, 0xf6,
        0x12, 0xa4,
    ],
    // R13 (Let's Encrypt RSA) intermediate
    [
        0x02, 0x54, 0x90, 0x86, 0x0b, 0x49, 0x8a, 0xb7, 0x3c, 0x6a, 0x12, 0xf2, 0x7a, 0x49, 0xad,
        0x5f, 0xe2, 0x30, 0xfa, 0xfe, 0x3a, 0xc8, 0xf6, 0x11, 0x2c, 0x9b, 0x7d, 0x0a, 0xad, 0x46,
        0x94, 0x1d,
    ],
    // E5 (Let's Encrypt ECDSA) intermediate
    [
        0x35, 0x86, 0xd4, 0xec, 0xf0, 0x70, 0x57, 0x8c, 0xbd, 0x27, 0xae, 0xdc, 0xe2, 0x0b, 0x96,
        0x4e, 0x48, 0xbc, 0x14, 0x9f, 0xae, 0xb9, 0xda, 0xd7, 0x2f, 0x46, 0xb8, 0x57, 0x86, 0x91,
        0x72, 0xb8,
    ],
    // E6 (Let's Encrypt ECDSA) intermediate
    [
        0xd0, 0x16, 0xe1, 0xfe, 0x31, 0x19, 0x48, 0xac, 0xa6, 0x4f, 0x2d, 0xe4, 0x4c, 0xe8, 0x6c,
        0x9a, 0x51, 0xca, 0x04, 0x1d, 0xf6, 0x10, 0x3b, 0xb5, 0x2a, 0x88, 0xeb, 0x3f, 0x76, 0x1f,
        0x57, 0xd7,
    ],
    // E7 (Let's Encrypt ECDSA) intermediate
    [
        0xcb, 0xbc, 0x55, 0x9b, 0x44, 0xd5, 0x24, 0xd6, 0xa1, 0x32, 0xbd, 0xac, 0x67, 0x27, 0x44,
        0xda, 0x34, 0x07, 0xf1, 0x2a, 0xae, 0x5d, 0x5f, 0x72, 0x2c, 0x5f, 0x6c, 0x79, 0x13, 0x87,
        0x1c, 0x75,
    ],
    // E8 (Let's Encrypt ECDSA) intermediate
    [
        0x88, 0x5b, 0xf0, 0x57, 0x22, 0x52, 0xc6, 0x74, 0x1d, 0xc9, 0xa5, 0x2f, 0x50, 0x44, 0x48,
        0x7f, 0xef, 0x2a, 0x93, 0xb8, 0x11, 0xcd, 0xed, 0xfa, 0xd7, 0x62, 0x4c, 0xc2, 0x83, 0xb7,
        0xcd, 0xd5,
    ],
];
    ...
    fn verify_server_cert(
            ...
            .any(|hash| PINNED_SPKI_HASHES.contains(&hash))
        {
            ...
            Err(rustls::Error::General(format!(
                "certificate chain for {server_name:?} did not match pinned SPKI set"
            )))
        }
    }
